                    ...
                    <div class="col-sm-9">
                        @foreach($programming_languages as $programming_language)
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" value="{{$programming_language->id}}"
                                       name="programmingLanguage[]" class="custom-control-input"
                                       id="customCheck11{{$programming_language->id}}">
                                <label class="custom-control-label"
                                       for="customCheck11{{$programming_language->id}}">{{$programming_language->name}}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
                        ...
                        @foreach($languages as $language)
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" name="language[]" value="{{$language->id}}"
                                       class="custom-control-input" id="customCheck101{{$language->id}}">
                                <label class="custom-control-label"
                                       for="customCheck101{{$language->id}}">{{$language->code}}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
